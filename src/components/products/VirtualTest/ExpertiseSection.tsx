    ...
    const expertise: ExpertiseItem[] = [
        {
            ...
            image: new URL('/assets/images/DSC0763.webp', import.meta.url).href
        },
        {
            id: 2,
            title: "Digitalized frames",
            subtitle: "Digitalized frames",
            description: "Photographic Studio - 3D Studio - Model Studio - Database",
            image: new URL('/assets/images/Microsoft.webp', import.meta.url).href
        },
        {
            id: 3,
            title: "Optical instruments",
            subtitle: "Optical instruments",
            description: "PD Measurement - Lens Simulator",
            image: new URL('/assets/images/DSC1777_square.webp', import.meta.url).href
        }
    ]

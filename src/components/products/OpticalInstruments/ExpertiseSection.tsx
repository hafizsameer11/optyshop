    ...
    const expertise: ExpertiseItem[] = [
        {
            id: 1,
            title: "Virtual Test",
            description: "for Website - for Ecommerce - for In-store",
        ...
        },
        {
            ...
            description: "Photo Studio - 3D Studio - 3D Database",
                                    ...
                                    <div className="relative h-80 md:h-96 rounded-2xl overflow-hidden group">
                                        <img
                                            ...
                                            onError={(e) => {
                                                ...
                                                else if (item.id === 2) target.src = '/assets/images/frame1.png'
                                                else target.src = '/assets/images/image.png'
                                            }}
                                        />
                                        {/* Dark Overlay */}

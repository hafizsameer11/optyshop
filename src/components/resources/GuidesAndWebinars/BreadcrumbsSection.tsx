...
const BreadcrumbsSection: React.FC = () => {
    return (
        <section className="relative bg-white">
            ...
            <div className="h-px bg-gradient-to-r from-purple-600 via-purple-500 to-purple-700"></div>
            ...
            <div className="w-[90%] mx-auto px-4 sm:px-6 py-4 md:py-6">
                ...
                <div className="flex flex-wrap items-center gap-2 md:gap-3 text-xs md:text-sm">
                    ...
                    <span className="text-gray-400">&gt;</span>
                    <span className="text-blue-900 uppercase font-semibold">GUIDES AND WEBINARS</span>
                </div>
            </div>
        </section>
    )

                ...
                <div className="grid lg:grid-cols-2 gap-0">
                    ...
                    <div className="relative text-white px-4 sm:px-6 md:px-12 lg:px-16 py-6 sm:py-8 md:py-12 lg:py-16 flex flex-col justify-center">
                        ...
                        <div className="relative z-10 w-full sm:w-[95%] mx-auto max-w-4xl space-y-6 sm:space-y-8">
                            <div>
                                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:pt-15 lg:text-4xl font-bold mb-4 sm:mb-6 leading-tight text-white whitespace-nowrap">
                                    Improve the online user experience
                                </h1>
                                <h2 className="text-lg sm:text-xl md:text-2xl font-normal mb-3 text-white">
                                    Make buying glasses easier with virtual trying-on
                                </h2>
                            ...
                            <div className="text-base sm:text-lg md:text-xl text-white leading-relaxed">
                                <p>
                                    Transform your e-commerce site into a{' '}
                                    <strong className="text-white font-bold">virtual mirror</strong> where your customers can see{' '}
                                    <strong className="text-white font-bold">your glasses directly on their faces!</strong>
                                </p>
                            </div>

                            <div className="pt-4 sm:pt-6">
                                <button className="px-8 sm:px-10 py-3 sm:py-4 text-base sm:text-lg bg-white text-slate-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-300 shadow-lg">
                                    Request a demo
                                </button>
                            </div>
                        </div>
